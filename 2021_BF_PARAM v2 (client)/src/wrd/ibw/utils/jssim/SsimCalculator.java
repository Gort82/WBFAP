...
public class SsimCalculator {
    ...
    public SsimCalculator(FrmEmbedWM frmEmbedWM){
    	this.imgWidth = frmEmbedWM.getEmbedImgWidth();
    	this.imgHeight = frmEmbedWM.gettEmbedImgHeigh();
		
    	this.embImg = new int[this.imgHeight][this.imgWidth]; 
    	this.embImg = frmEmbedWM.getImgToEmbed();
    ...
    public double compareInternal() throws SsimException, IOException {
        //final byte[] compBytes = loadFile(comp);
        final byte[] compBytes = null;
        final WindowManager manager = getWindowManager(compBytes);
    ...
    public double compareInternal(File comp) throws SsimException, IOException {
        final byte[] compBytes = loadFile(comp);
        final WindowManager manager = getWindowManager(compBytes);
